...
find /var/www/html/base_saluteora -name "*.md" -type f -print0 | xargs -0 grep -l "\[.*\](/var/www/html/" | while read file; do
...
echo "Esempio:"
echo "  [Documento](/var/www/html/base_saluteora/docs/file.md) → [Documento](../docs/file.md)"
