...
.thead {
 ...
 <page>
    <h4 style="text-align:center;">SISTEMA DI MISURAZIONE E VALUTAZIONE DELLA PERFORMANCE INDIVIDUALE - Anno {{$row->anno}}<br/>
    <small>Scheda di valutazione del PERSONALE NON DIRIGENZIALE</small></h4>
    <span class="head">
    ...
    <table class="morpion" style="width:100%;border:1px solid gray;">
        ...
        <tr>
            <td rowspan="4"><!--(risultati_ottenuti)--><b>Conseguimento degli obiettivi</b> assegnati mediante la realizzazione dei prodotti richiesti e necessari alle attivit&agrave; dei processi di diretto coinvolgimento, con livello qualitativo / quantitativo adeguato a garantire prodotti finali di qualit&agrave; nel rispetto dei tempi di consegna</td>

            <td>Consegue gli obiettivi assegnati mediante la realizzazione dei prodotti richiesti senza la sufficiente perizia non consentendo esaustivit&agrave; contenutistica e correttezza formale nel livello quali/quantitativo richiesto, non rispettando i tempi di consegna</td>
