            ...
            <tr>
				...
				<br/>gg_aspettative_pond_fuori_sede :{{ $row->gg_aspettative_pond_fuori_sede }} --}}
                    ...
                    @php
                        ...
                        //echo $route;
                    @endphp
                    <a class="btn btn-small btn-default" data-toggle="tooltip" title="Crea PDF"
                        href="{{ $route }}"><i class="fa fa-file-pdf-o fa-fw" aria-hidden="true"></i>&nbsp;PDF</a>
                    @php
                        $parz = ['stabi' => $row->stabi, 'repar' => $row->repar, 'anno' => $row->anno, 'id_schede' => $row->id];
                        $route = route('progressioni.ctrlmatr.updaterow', $parz);
                        //echo $route;
                    @endphp
                    <a class="btn btn-small btn-default" data-toggle="tooltip" title="Aggiorna Dati"
                        href="{{ $route }}"><i class="fa fa-refresh fa-fw"
                            aria-hidden="true"></i>&nbsp;Aggiorna</a>
