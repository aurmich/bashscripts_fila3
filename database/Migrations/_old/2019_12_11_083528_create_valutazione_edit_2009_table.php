...
/**
 * Class CreateValutazioneEdit2009Table.
 */
class CreateValutazioneEdit2009Table extends XotBaseMigration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('valutazione_edit_2009', static function (Blueprint $table): void {
    ...
    {
        Schema::drop('valutazione_edit_2009');
    }
}
