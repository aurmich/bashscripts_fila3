...
/**
 * Class CreateValutazione2010Table.
 */
class CreateValutazione2010Table extends XotBaseMigration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('valutazione_2010', static function (Blueprint $table): void {
