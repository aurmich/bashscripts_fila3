...
use Filament\Forms;
use Filament\Tables;
use Modules\Performance\Filament\Resources\PerformanceResource\Pages;
    ...
    public static function getListTableColumns(): array
    {
        return [
            ...
            "repar" => Tables\Columns\TextColumn::make("repar")
                ->numeric()
                ->sortable(),
            "stabival" => Tables\Columns\TextColumn::make("stabival")
                ->numeric()
                ->sortable(),
            "reparval" => Tables\Columns\TextColumn::make("reparval")
                ->numeric()
                ->sortable(),
            ...
            "repar_txt" => Tables\Columns\TextColumn::make("repar_txt")
                ->searchable(),
            "disci" => Tables\Columns\TextColumn::make("disci")
                ->numeric()
                ->sortable(),
            "disci_txt" => Tables\Columns\TextColumn::make("disci_txt")
                ->searchable(),
            "rep2kd" => Tables\Columns\TextColumn::make("rep2kd")
                ->numeric()
                ->sortable(),
            "rep2ka" => Tables\Columns\TextColumn::make("rep2ka")
                ->numeric()
                ->sortable(),
            ...
            "categoria_eco" => Tables\Columns\TextColumn::make("categoria_eco")
                ->searchable(),
            "qua2kd" => Tables\Columns\TextColumn::make("qua2kd")
                ->numeric()
                ->sortable(),
            "qua2ka" => Tables\Columns\TextColumn::make("qua2ka")
                ->numeric()
                ->sortable(),
            ...
            "anno" => Tables\Columns\TextColumn::make("anno")
                ->numeric()
                ->sortable(),
            "excellence" => Tables\Columns\IconColumn::make("excellence")
                ->boolean(),
            "gg_anno" => Tables\Columns\TextColumn::make("gg_anno")
                ->numeric()
                ->sortable(),
        ];
    }
