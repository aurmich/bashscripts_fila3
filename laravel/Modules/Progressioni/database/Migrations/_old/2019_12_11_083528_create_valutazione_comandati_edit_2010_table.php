...
/**
 * Class CreateValutazioneComandatiEdit2010Table.
 */
class CreateValutazioneComandatiEdit2010Table extends XotBaseMigration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('valutazione_comandati_edit_2010', static function (Blueprint $table): void {
    ...
    {
        Schema::drop('valutazione_comandati_edit_2010');
    }
}
