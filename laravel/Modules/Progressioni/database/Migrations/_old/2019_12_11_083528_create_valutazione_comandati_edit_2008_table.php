...
/**
 * Class CreateValutazioneComandatiEdit2008Table.
 */
class CreateValutazioneComandatiEdit2008Table extends XotBaseMigration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('valutazione_comandati_edit_2008', static function (Blueprint $table): void {
    ...
    {
        Schema::drop('valutazione_comandati_edit_2008');
    }
}
