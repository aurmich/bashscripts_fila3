...
/**
 * Class CreateValutazione2009Table.
 */
class CreateValutazione2009Table extends XotBaseMigration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('valutazione_2009', static function (Blueprint $table): void {
