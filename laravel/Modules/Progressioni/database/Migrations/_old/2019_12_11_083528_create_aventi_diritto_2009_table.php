...
/**
 * Class CreateAventiDiritto2009Table.
 */
class CreateAventiDiritto2009Table extends XotBaseMigration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('aventi_diritto_2009', static function (Blueprint $table): void {
    ...
    {
        Schema::drop('aventi_diritto_2009');
    }
}
